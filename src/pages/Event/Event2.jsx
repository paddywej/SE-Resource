      ...
      <div className="event-detail-container">
        ...
        <div className="event-details">
          ...
          <div className="event-info">
            ...
            {event.details && <p><strong>Details:</strong></p>}
            <p>We invite high school students of all levels to attend the OpenHouse event for the Faculty of Agricultural Technology, KMITL, on Friday, November 29, 2024.</p>
            <li>Participate in the Workshop with various activities from every field of study.</li>
            <li>Learn all the sciences.</li>
            <p>Every workshop and every activity has a certificate.</p>
